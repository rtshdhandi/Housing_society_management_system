...
<div class="row">
	...
	<div class="col-md-8">
		<form class="form-container" action="maintanance2.php" method="POST">
		 <h3> MAINTANANCE</h3>
		<div class="row">
...
{	
	...
	?><td><?php echo $row1['memberid'] ?></td>
	<td> <input type="text" name="roomno" value="<?php echo $row1['roomno'] ?>"></input></td>
	<td><?php echo $row['persquareft']* $row1['area'] ?></td>
	<td><?php echo $row['maintanance'] ?></td>
...
<p align="center">
<input type="button" onclick="location.href='calculatemaintanance.php'"value=" Generate Maintance Bill" name="print"  class="btn btn-success"></p></div>
